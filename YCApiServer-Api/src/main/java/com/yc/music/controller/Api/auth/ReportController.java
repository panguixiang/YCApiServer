...
import com.yc.music.service.service103.ReportService;
...
public class ReportController {
	...
	public Map<String,Object> reportSave(@Valid Report report, BindingResult binding) {
		Map<String,Object> result = new HashMap<String,Object>();
		try {
			reportService.saveReport(report, binding, result);
		} catch (Exception e) {
